 ...
 * @author admin
 */
public class ADEditSettingController extends BaseRequiredAuthorization {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ADEditSettingController</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ADEditSettingController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
   ...
   @Override
    protected void processGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Setting setting = sedao.getSettingById(settingId);
    ...
    protected void processPost(HttpServletRequest request, HttpServletResponse response)
        ...
        SettingDAO sedao = new SettingDAO();
        sedao.UpdateSettingById(settingId, typeId, value, order, statusId, description);
        
        response.sendRedirect("/src/admin/viewsetting?settingId=" +settingId );
    }
