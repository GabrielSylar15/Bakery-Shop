 ...
 * @author admin
 */
public class MKTViewPostController extends BaseRequiredAuthorization {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       int id = Integer.parseInt(request.getParameter("postID"));
        ...
        request.getRequestDispatcher("/View/Marketing/Post/ViewPost.jsp").forward(request, response);
    }
