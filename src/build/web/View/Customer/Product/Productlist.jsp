                                ...
                                <c:forEach items="${listProduct}" var="P">
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6">
                                        <div class="ps-product">
                                            <div class="ps-product__thumbnail">
                                                <a class="" href="details?productID=${P.productID}"><img  src="${P.thumbnail}" alt=""/></a>
                                                ...
                                                <div class="ps-product__content">
                                                    <div class="ps-product__desc">
                                                        <a class="ps-product__title" href="details?productID=${P.productID}">${P.productName}</a> <br>
                                                ...
                                                <div class="ps-product__shopping "><a class="ps-btn ps-product__add-to-cart" href="addtocart?productID=${P.productID}">Add to cart</a>
                                                    <div class="ps-product__actions"><a href="details?productID=${P.productID}"><i class="fa fa-commenting-o"></i></a></div>
                                                </div>
