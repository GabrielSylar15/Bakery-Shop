                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body table-border-style">
                                                <div class="table-responsive">
                                                    <form action="/src/marketing/insertpost" name="formInsert" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-body">
                                                          ...
                                                          <div class="modal-footer">
                                                                <input type="submit" name="post" class="btn btn-success" onclick="return myFunction()" value="Post">
