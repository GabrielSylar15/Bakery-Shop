...
<html lang="en">
    ...
    <body>
        <header class="header header--default header--home-4 line" data-sticky="true">
            ...
            <div class="header__right">
                <div class="header__actions">
                    ...
                    <c:if test="${sessionScope.user == null}">
                        ...
                        <a data-toggle="modal" href="#myLoginForm"><i class="fa fa-sign-in" ></i></a>
                        </c:if>
                        <c:if test="${sessionScope.user != null}">
            ...
            <!--Login-->
            <div class="modal" id="myLoginForm">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="/src/comment/login" method="post">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="/src/user/resetpassword" class="float-right">Forgot Password?</a>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <div class="ps-panel--sidebar" id="navigation-mobile">
            ...
            <div class="ps-panel__content">
                <ul class="menu--mobile">
                    <li class="menu-item-has-children"><a href="/src/comment/homepage">Home</a><span class="sub-toggle"></span>
                        <ul class="sub-menu">
                            <li class="current-menu-item "><a href="/src/comment/homepage">Homepage 1</a>
                            </li>
