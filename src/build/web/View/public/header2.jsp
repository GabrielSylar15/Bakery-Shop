        ...
        <header class="header header--default" data-sticky="true">
            ...
            <div class="header__right">
                <div class="header__actions">
                    ...
                    <c:if test="${sessionScope.user == null}">
                        <a  class="ps-search-btn" href="#myRegisterForm"><i class="fa fa-user-plus"></i></a>
                        ...
                        <div class="ps-cart--mini"><i class="fa fa-bars"></i></a>
                            <div class="ps-cart__content">
                                <div class="ps-cart__items">
                                    ...
                                    <div class="ps-product--mini-cart">
                                        <div class="ps-product__content"><a class="ps-product__title" href="/src/marketing/feedbacklist">Marketing Manage</a>
                                        </div>
                                    </div>
                                    </c:if>
                                    ...
                                    <div class="ps-product--mini-cart">
                                        <div class="ps-product__content"><a class="ps-product__title" href="/src/sale/orderlist">Sale Manage</a>
                                        </div>
                                    </div>
                                    </c:if>
                                </div>
