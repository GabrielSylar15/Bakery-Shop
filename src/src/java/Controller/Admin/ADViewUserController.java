 ...
 * @author Huy Thai
 */
public class ADViewUserController extends BaseRequiredAuthorization {
...
//            User u = (User)request.getSession().getAttribute("user");
            ...
            User u = ud.GetUserProfileById(id);
            request.setAttribute("user", u);
            request.getRequestDispatcher("/View/Admin/User/UserDetails.jsp").forward(request, response);
