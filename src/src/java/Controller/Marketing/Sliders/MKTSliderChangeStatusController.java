 ...
 * @author admin
 */
public class MKTSliderChangeStatusController extends BaseRequiredAuthorization {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setContentType("text/html;charset=UTF-8");
        ...
        sdao.UpdateStatus(sId,status);
        response.sendRedirect("/src/marketing/sliderlist");
    }
