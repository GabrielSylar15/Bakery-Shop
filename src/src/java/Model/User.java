...
public class User {
    ...
    public String toString() {
        return "User{" + "id=" + id + ", email=" + email + ", password=" + password + ", roleID=" + roleID + ", name=" + name + ", mobile=" + mobile + ", image=" + image + ", gender=" + gender + ", token=" + token + ", expirationToken=" + expirationToken + ", address=" + address + ", status=" + status + ", roleID2=" + roleID2 + '}';
    }
