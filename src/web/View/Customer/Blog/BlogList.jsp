                ...
                <div class="ps-blog ps-blog--sidebar">
                    <div class="ps-blog__left">
                        ...
                        <c:forEach items="${requestScope.lsPagingBlog}" var="c">
                            <div class="ps-post">
                                <div class="ps-post__thumbnail"><img src="${c.thumbnail}" alt=""><a class="ps-post__overlay" href="customer/blogdetail?postId=${c.postID}"></a></div>
                                <div class="ps-post__content">
                                    <p class="ps-post__meta">by<a href="#"> ${c.userID.email}</a></p><a class="ps-post__title" href="customer/blogdetail?postId=${c.postID}">${c.postTitle}</a>
                                    <p>${c.briefInformation}</p>
                                    <a class="ps-post__morelink" href="customer/blogdetail?postId=${c.postID}">Read More</a>
                                </div>
                            </div>
                        </c:forEach>
                            ...
                            <div class="ps-pagination" >
                                <ul class="pagination">
                                    ...
                                    <c:if test="${requestScope.currentPage > 1}">
                                        <li><a href="customer/bloglist?currentPage=${requestScope.currentPage - 1}"><i class="fa fa-caret-left"></i></a></li>
                                            </c:if> 

                                    <c:choose>
                                        <c:when test="${requestScope.endPage <= 4}">
                                            <c:forEach begin="1" end="${requestScope.endPage}" var="c">
                                                <li><a href="customer/bloglist?currentPage=${c}&categoryID=${categoryID}&currentPageCate=${currentPageCate}">${c}</a></li>
                                                </c:forEach>
                                        ...
                                        <c:otherwise>
                                            ...
                                            <c:if test="${requestScope.currentPage == 1}">
                                                ...
                                                <li><a>...</a></li>
                                                <li><a href="customer/bloglist?currentPage=${c}&categoryID=${categoryID}&currentPageCate=${currentPageCate}">${endPage}</a></li>
                                                </c:if>
                                            ...
                                            <c:if test="${requestScope.currentPage >= endPage - 2 && requestScope.currentPage <= endPage}">
                                                <li><a href="customer/bloglist?currentPage=1&categoryID=${categoryID}&currentPageCate=${currentPageCate}">1</a></li>
                                                <li><a>...</a></li>
                                    ...
                                    <c:if test="${requestScope.currentPage < endPage}">
                                        <li><a href="customer/bloglist?currentPage=${requestScope.currentPage - 1}&categoryID=${categoryID}&currentPageCate=${currentPageCate}"><i class="fa fa-caret-right"></i></a></li>
                                            </c:if> 
                    ...
                    <div class="ps-blog__right">
                        <aside class="widget widget_search">
                            <form class="ps-form--widget-search" action="customer/bloglist" name="searchBlog" method="post">
                        ...
                        <aside class="widget widget_blog widget_blog-categories">
                            ...
                            <ul class="ps-list--arrow">
                                ...
                                <c:forEach items="${requestScope.lsPagingBlogCategory}" var="c">
                                    <li><a href="customer/bloglist?categoryID=${c.postCategoryID}&currentPageCate=${currentPageCate}&currentPage=${currentPage}">${c.postCategoryName}</a></li>
                                    </c:forEach>
                            </ul>
                            <div class="pagination">
                                <ul class="pagination">
                                    ...
                                    <c:if test="${currentPageCate >1}">  
                                        <li><a href="customer/bloglist?currentPageCate=${currentPageCate-1}&categoryID=${categoryID}&currentPage=${currentPage}"><i class="fa fa-caret-left"></i></a></li>
                                            </c:if> 
                                    <li><a href="#">${currentPageCate}/${requestScope.blogCatePage}</a></li>
                                        ...
                                        <li><a href="customer/bloglist?currentPageCate=${currentPageCate+1}&categoryID=${categoryID}&currentPage=${currentPage}"><i class="fa fa-caret-right"></i></a></li>
                                            </c:if>
                                </ul>
                            </div>
